...
@section('content')
    ...
    <div>
        <div class="container py-5 mb-5">
            <h1>Privacy Policy for balanja.id</h1>

            <p>At balanja.id, accessible from https://balanja.id/, one of our main priorities is the privacy of our
                visitors. This Privacy Policy document contains types of information that is collected and recorded by
                balanja.id and how we use it.</p>
            ...
            <p>balanja.id follows a standard procedure of using log files. These files log visitors when they visit
            ...
            <P>You may consult this list to find the Privacy Policy for each of the advertising partners of balanja.id.</p>

            <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
                used in their respective advertisements and links that appear on balanja.id, which are sent directly to
            ...
            <p>Note that balanja.id has no access to or control over these cookies that are used by third-party advertisers.
            </p>

            <h2>Third Party Privacy Policies</h2>

            <p>balanja.id's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
            ...
            <p>balanja.id does not knowingly collect any Personal Identifiable Information from children under the age of
            ...
            <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
                regards to the information that they shared and/or collect in balanja.id. This policy is not applicable to
