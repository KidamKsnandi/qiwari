                ...
                <div class="card-body">
                    ...
                    <form action="">
                        ...
                        <div class="form-group mb-2">
                            ...
                            <select disabled name="kecamatan_id" id="kecamatan_id"
                                class="theSelect form-control mb-2" style="width: 100%;" id="">
                                <option value="">- Pilih -</option>
                            </select>
                        </div>
                        <div class="form-group mb-2">
                            <h6 style="font-size: 13px;" class="mt-3">DESA/KELURAHAN</h6>
                            <select disabled name="kelurahan_id" id="kelurahan_id"
                                class="theSelect form-control mb-2" style="width: 100%;" id="">
                                <option value="">- Pilih -</option>
                            </select>
                        </div>
