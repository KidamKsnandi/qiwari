...
@section('content')
<main id="main" class="" style="background: whitesmoke; border-top: 1px solid rgb(230, 230, 230);">
    ...
    var API_SECRET = document.querySelector('meta[name="api-secret"]').getAttribute('content');
        ...
        function showSkeleton(count = 3) {
            ...
            .then(res => {
                ...
                data.forEach(item => {
                const nama = item.nama_cabang || "Nama Tidak Tersedia";
                const kota = item.kota_kab || "Kota Tidak Tersedia";
                const foto = item.photo 
                    ? `https://api.balanja.kehosting.in/${item.photo}` 
                    : "https://cdn.pixabay.com/photo/2023/02/18/11/00/icon-7797704_640.png";
                const rating = item.rating || "0.0";
                const sertifikasi = item.sertifikasi || "Tersertifikasi";
                    ...
                    <div class="card shadow-sm border-0 rounded-4 h-100">
                        ...
                        <div class="col-8">
                            ...
                            <div class="d-flex flex-wrap gap-3 mb-2">
                                ...
                                <i class="bi bi-award-fill text--primary me-1"></i> ${sertifikasi}
                                </span>
                                <span class="d-flex align-items-center small text-muted">
