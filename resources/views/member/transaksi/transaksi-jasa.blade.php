...
@section('content')
    ...
    <div class="container mt-2 py-5">
        <h3 class="fw-bold">Transaksi Jasa</h3>
        <div class="d-flex mb-3">
            <a href="/transaksi/jasa" class="tab-btn active">Transaksi Jasa</a>
            <a href="/transaksi/produk" class="tab-btn">Transaksi Produk</a>
        </div>
    ...
    var API_SECRET = document.querySelector('meta[name="api-secret"]').getAttribute('content');
        ...
        if (user) {
            $('#contents').html(`
                <!-- Tab links -->
                <div class="card border-0" style="border-radius: 15px; background: whitesmoke;">
                <div class="p-2">
                <ul class="nav nav-tabs nav-fill modern-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="diperjalanan-tab" data-bs-toggle="tab" href="#diperjalanan" role="tab"
                            aria-controls="diperjalanan" aria-selected="false">
                            <span class="position-relative">
                                Diperjalanan
                                <span id="jmlDiperjalanan" class="ms-1 rounded-pill badge bg-danger"></span></span>
                            </span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="ditujuan-tab" data-bs-toggle="tab" href="#ditujuan" role="tab"
                            aria-controls="ditujuan" aria-selected="false">
                            <span class="position-relative">
                                Ditujuan
                                <span id="jmlDitujuan" class="ms-1 rounded-pill badge bg-danger"></span></span>
                            </span>
                        </a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="tab-content mt-3" id="myTabContent">
                ...
                <div class="tab-pane fade" id="diperjalanan" role="tabpanel" aria-labelledby="diperjalanan-tab">
                    <!-- List of orders - Dikirim -->
                    <!-- Add your content here -->
                </div>
                <div class="tab-pane fade" id="ditujuan" role="tabpanel" aria-labelledby="ditujuan-tab">
                    ...
                    if (dataTransaksiPending[0] == null) {
                        ...
                        $.each(dataTransaksiPending, function(key, value) {
                            ...
                            <div class="card-transaksi shadow mt-2" style="border-radius: 15px; cursor: pointer;" onclick='lihatDetail(${JSON.stringify(value)})' style="cursor:pointer">
                                <div class="p-4">
                                    <div class="text-danger mb-1">Pending (${value.status_bayar == 'lunas' ?  'Lunas' : 'Belum Lunas'})</div>
                ...
                .then(function(response) {
                    ...
                    if (dataTransaksiProses[0] == null) {
                        ...
                        $.each(dataTransaksiProses, function(key, value) {
                            ...
                            <div class="card-transaksi shadow mt-2" style="border-radius: 15px; cursor: pointer;" onclick='lihatDetail(${JSON.stringify(value)})' style="cursor:pointer">
                                <div class="p-4">
                                    <div class="text--primary mb-1">Diproses</div>
                                    <h5 class="card-title fw-bold">${value.no_invoice}</h5>
                                    <div class="d-flex justify-content-between">
                                        <span class="card-text">Tanggal Transaksi</span>
                                        <span class="card-text">Nominal</span>
            ...
            // diperjalanan
            axios.get(
                    `${API_URL}/transaksi-online?konsumen_member_id=${JSON.parse(user).karyawan.id}&show_bukti_tf=1&status=diperjalanan&view_as_invoice=1&start=0&length=20&transaction_type=jasa`, {
                        headers: {
                            'secret': 'aKndsan23928h98hKJbkjwlKHD9dsbjwiobqUJGHBDWHvkHSJQUBSQOPSAJHVwoihdapq',
                            'Author': 'bearer ' + token,
                            'device': 'web'
                ...
                .then(function(response) {
                    ...
                    if (dataTransaksiKirim[0] == null) {
                        ...
                        if (dataTransaksiKirim.length > 0) {
                            $('#jmlDiperjalanan').html(dataTransaksiKirim.length)
                        }
                                ...
                                <div class="p-4">
                                    <div class="row">
                                        <div class="col-sm order-2 order-sm-1">
                                            <div class="text--primary mb-1">Diperjalanan</div>
                                            <h5 class="card-title fw-bold mb-2">${value.no_invoice}</h5>
                                        </div>
                                        <div class="col-sm order-1 order-sm-2">
                                            <button class="float-sm-end btn btn-outline-primary mb-2 w-sm-auto">
                                            Terapis Sampai Ditujuan
                                            </button>
                                        </div>
                                    </div>
            ...
            // ditujuan
            axios.get(
                    `${API_URL}/transaksi-online?konsumen_member_id=${JSON.parse(user).karyawan.id}&show_bukti_tf=1&status=ditujuan&view_as_invoice=1&start=0&length=20&transaction_type=jasa`, {
                        headers: {
                            'secret': 'aKndsan23928h98hKJbkjwlKHD9dsbjwiobqUJGHBDWHvkHSJQUBSQOPSAJHVwoihdapq',
                            'Author': 'bearer ' + token,
                            'device': 'web'
                ...
                .then(function(response) {
                    ...
                    if (dataTransaksiTerima[0] == null) {
                        ...
                        if (dataTransaksiTerima.length > 0) {
                            $('#jmlDitujuan').html(dataTransaksiTerima.length)
                        }
                        $.each(dataTransaksiTerima, function(key, value) {
                            ...
                            <div class="card-transaksi shadow mt-2" style="border-radius: 15px; cursor: pointer;" onclick='lihatDetail(${JSON.stringify(value)})' style="cursor:pointer">
                                <div class="p-4">
                                    <div class="row">
                                        <div class="col-sm order-2 order-sm-1">
                                            <div class="text--primary mb-1">Ditujuan</div>
                                            <h5 class="card-title fw-bold mb-2">${value.no_invoice}</h5>
                                        </div>
                                        <div class="col-sm order-1 order-sm-2">
                                            <button class="float-sm-end btn btn-outline-primary mb-2 w-sm-auto">
                ...
                .then(function(response) {
                    ...
                    if (dataTransaksiSelesai[0] == null) {
                        ...
                        $.each(dataTransaksiSelesai, function(key, value) {
                            ...
                            <div class="card-transaksi shadow mt-2" style="border-radius: 15px; cursor: pointer;" onclick='lihatDetail(${JSON.stringify(value)})' style="cursor:pointer">
                                <div class="p-4">
                                    <div class="text--primary mb-1">Selesai</div>
                                    <h5 class="card-title fw-bold">${value.no_invoice}</h5>
                                    <div class="d-flex justify-content-between">
                                        <span class="card-text">Tanggal Transaksi</span>
                                        <span class="card-text">Nominal</span>
                ...
                .then(function(response) {
                    ...
                    if (dataTransaksiBatal[0] == null) {
                        ...
                        $.each(dataTransaksiBatal, function(key, value) {
                            ...
                            <div class="card-transaksi shadow mt-2" style="border-radius: 15px; cursor: pointer;" onclick='lihatDetail(${JSON.stringify(value)})' style="cursor:pointer">
                                <div class="p-4">
                                    <div class="text--primary mb-1">Dibatalkan</div>
                                    <h5 class="card-title fw-bold">${value.no_invoice}</h5>
                                    <div class="d-flex justify-content-between">
                                        <span class="card-text">Tanggal Transaksi</span>
                                        <span class="card-text">Nominal</span>
            ...
            $.each(dataTransaksi, (key, value) => {
                ...
                <div class="card-transaksi shadow mt-2" style="border-radius: 15px; cursor: pointer;" onclick='lihatDetail(${JSON.stringify(value)})' style="cursor:pointer">
                    <div class="p-4">
                        <div class="text--primary mb-1">${value.stdivtus_bayar == 'lunas' ? 'Lunas' : 'Belum Lunas'}</p>
                        <h5 class="card-title fw-bold">${value.no_invoice}</h5>
                        <div class="d-flex justify-content-between">
                            <span class="card-text">Tanggal Transaksi</span>
                            <span class="card-text">Nominal</span>
